...
public final class SettingsDao_Impl implements SettingsDao {
  ...
  public SettingsDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfSettingEntity = new EntityInsertionAdapter<SettingEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `assistant_settings` (`key`,`value`,`updatedAtEpochMs`) VALUES (?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(3, entity.getUpdatedAtEpochMs());
      }
    };
  }
  ...
  @Override
  public Object getByKey(final String key, final Continuation<? super SettingEntity> $completion) {
    final String _sql = "SELECT * FROM assistant_settings WHERE key = ?";
      ...
      public SettingEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new SettingEntity(_tmpKey,_tmpValue,_tmpUpdatedAtEpochMs);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<List<SettingEntity>> observeAll() {
    final String _sql = "SELECT * FROM assistant_settings";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"assistant_settings"}, new Callable<List<SettingEntity>>() {
      @Override
      @NonNull
      public List<SettingEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final long _tmpUpdatedAtEpochMs;
            _tmpUpdatedAtEpochMs = _cursor.getLong(_cursorIndexOfUpdatedAtEpochMs);
            _item = new SettingEntity(_tmpKey,_tmpValue,_tmpUpdatedAtEpochMs);
            _result.add(_item);
          }
          return _result;
        } finally {
